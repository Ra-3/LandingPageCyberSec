export const features = [
  {
    id: "0",
    icon: "/images/feature-5.png",
    caption: "Easy integration",
    title: "5x Faster",
    text: "Get penetration test results in days, not weeks, without breaking your budget.",
    button: {
  ...
  {
    id: "1",
    icon: "/images/feature-6.png",
    caption: "Secure & trustworthy",
    title: "Zero Jargon",
    text: "Clear, actionable pentest reports your team can actually understand",
    button: {
  ...
  },
  {
    ...
    caption: "Strict Regulations",
    title: "Compliance",
    text: "Meet SOC 2, ISO 27001, GDPR, and other security requirements with ease",
    button: {
      icon: "/images/docs.svg",
      title: "Read the docs",
    },
...
export const faq = [
  {
    id: "0",
    question: "GenAI Security Testing",
    answer:
      "Specialized security testing for GenAI applications and LLM implementations based on the OWASP Top 10 LLM vulnerabilities.✅OWASP Top 10 LLM vulnerability testing.✅Prompt injection and data leakage detection",
  },
  {
    id: "1",
    question: "Continuous Penetration Testing",
    answer:
      "Our flagship service combines automated scanning with manual testing by certified security experts, providing continuous monitoring rather than point-in-time assessments.",
  },
  {
    id: "2",
    question: "DAST Scanner Service",
    answer:
      "Our Dynamic Application Security Testing scanner offers tiered options to accommodate businesses of all sizes, with specialized capabilities for GenAI applications.",
  },
  {
    id: "3",
    question: "Vulnerability Scanning",
    answer:
      "Automated scanning to identify common vulnerabilities across your infrastructure and applications.",
  },
  {
    id: "4",
    question: "Compliance Solutions",
    answer:
      "Specialized compliance solutions to help your business meet regulatory requirements and industry standards.",
  },
  {
    id: "5",
    question: "Vulnerability Management",
    answer:
      "Ongoing monitoring and remediation support to address vulnerabilities as they emerge.",
  },
  {
    id: "6",
    question: "Canadian Market Focus",
    answer:
      "Our services are specifically tailored to meet the unique needs of Canadian businesses.",
  },
];
...
export const plans = [
  ...
  },
  {
    ...
    features: [
      "5 web applications or APIs",
      "Bi-weekly scheduled scans",
      "Priority email & chat support",
      "Full compliance reporting (SOC 2, GDPR)",
      "LLM security testing (1 model)",
  ...
  },
  {
    ...
    features: [
      "Unlimited applications & APIs",
      "Custom scan scheduling",
      "Advanced vulnerability detection",
      "24/7 priority support",
      "Custom compliance reporting",
      "LLM security testing (unlimited)",
...
export const testimonials = [
  {
    id: "0",
    name: "Jordan",
    role: "Head of IT, Rivalry",
    avatarUrl: "/images/testimonials/jessica-saunders.png",
    comment:
      "DeepScan's penetration testing was crucial for our online betting platform. Their team identified vulnerabilities in our payment systems that could have led to serious financial and reputational damage",
  },
  {
    id: "1",
    name: "Tahsheen",
    role: "CEO, Penfield AI",
...
export const logos = [
  {
    id: "0",
    title: "Afterpay",
    url: "/images/logos/afterpay22.svg",
    width: 156,
    height: 48,
  },
  {
